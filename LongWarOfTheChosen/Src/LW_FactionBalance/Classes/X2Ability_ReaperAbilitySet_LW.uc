...
static function X2DataTemplate AddCripplingStrike()
{
	...
	local X2Condition_UnitEffects			SuppressedCondition;
	local X2Condition_UnitProperty			UnitPropertyCondition;
	local X2Effect_Persistent				CrippledEffect;
	...
	CrippledEffect = class'X2StatusEffects_LW'.static.CreateCrippledStatusEffect(
			class'X2StatusEffects_LW'.default.CRIPPLED_DEFAULT_DURATION);
